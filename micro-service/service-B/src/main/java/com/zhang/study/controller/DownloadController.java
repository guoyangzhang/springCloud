 ...
 * @author 杨燕吉
 * @version 1.0
 * Created by 杨燕吉 on 2019/9/8 9:04
...
public class DownloadController {
    ...
    @GetMapping("/download")
    @ResponseBody
    public void download(HttpServletResponse response, @RequestParam(value = "pathUrl") String pathUrl) {
        BufferedInputStream bis = null;
        try {
            File file = new File(saveFilePath + pathUrl);
            if (file.exists()) {
                long p = 0L;
                long toLength = 0L;
